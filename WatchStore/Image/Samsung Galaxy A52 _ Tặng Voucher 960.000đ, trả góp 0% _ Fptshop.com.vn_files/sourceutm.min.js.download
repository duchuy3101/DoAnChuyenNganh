...
}else if (window.location.href.indexOf("indoleads") > 0) {
    if (getQueryParams("utm_source") != null) {
	utm_eraseCookie("srf_b686d28583fc");
        utm_createCookie("srf_b686d28583fc", getQueryParams("utm_source") + "/#" + getQueryParams("sub1") + "/#" + getQueryParams("sub2"), 30);
    }
}else {
